...
public class JedisUtils {
	...
	public static void setObject(Pipeline pipeline , String key, Object value, int cacheSeconds) {
			pipeline.set(getBytesKey(key), toBytes(value));
	}
